...
export default function Navbar() {
  ...
  return (
    <Disclosure as="nav" className="bg-gray-800">
        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex shrink-0 items-center">
              <img alt="GneVibe" src="./logo.jpg" className="h-8 rounded-mdr" />
            </div>
            {token && ( // Only show navigation if authenticated
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            {token ? (
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    <MenuButton className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      <img
                        alt=""
                        src={userProfile?.image || "https://placehold.co/48x48"}
              ...
              // Show Register link if not authenticated
              <Link
                to="/register"
      ...
      {token && ( // Only show mobile menu if authenticated
